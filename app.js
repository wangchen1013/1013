...
//   //  /user 
//   if(req.cookies.isLogin === 'yes' || req.url==='/login' || req.url==='/login/in'){
//      next()
//   }else {
...
//以下两个是处理错误的 中间件！！！一个是 状态码错误处理 一个是全局错误处理  脚手架自动给你处理一个状态码
...
app.use(function(err, req, res, next) {
  ...
  // ！！！这是渲染的意思，渲染错误，去views里面找，要使用ejs引擎（静态资源文件都在上面的路径里面，即代码20行处）
  res.render('error');
});
